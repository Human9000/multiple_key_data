...
with open('392.csv', 'r', encoding='utf8') as f:
    lines = f.readlines()
...
指标 = ['D-AMDR', 'U-AMDR', 'U-AMDR', 'D-AMDR', 'U-AMDR', 'D-AMDR', "U-AMDR", 'D-AMDR', "AI"]
元素 = ['总脂肪', '总脂肪', '饱和脂肪酸', 'n-6多不饱和脂肪酸', 'n-6多不饱和脂肪酸', 'n-3多不饱和脂肪酸',
      'n-3多不饱和脂肪酸', 'EPA+DHA', 'EPA+DHA', 'DHA']
孕期 = ['不是', '早期', '中期', '晚期', '乳母']
